...
export function formatHelpMessage(i18n: I18n): string {
    const sections = [
        ...
        "",
        i18n.t("help.voice_switch.title"),
        i18n.t("help.voice_switch.description"),
        i18n.t("help.voice_switch.view_command"),
        i18n.t("help.voice_switch.list_command"),
        i18n.t("help.voice_switch.switch_command"),
        "",
        i18n.t("help.voice_switch.example"),
        "",
